<%@ Page Title="" Language="C#" MasterPageFile="~/MasterUpload.master" AutoEventWireup="true" CodeFile="SBMUpload.aspx.cs" Inherits="SBMUpload" %>
        ...
        <div class="container">
            ...
            <div class="row fileupload-buttonbar">
                <div class="col-lg-7">
                    ...
                    <%-- <input type="button" name="name" id="btnUpload" value="Start Upload" onclick="startUpload()" />
                <asp:Button Text="Start" ID="btnStart" class="btn btn-primary start" runat="server" OnClick="btnStart_Click" />--%>
